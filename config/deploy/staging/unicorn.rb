...
##### SET THESE VARIABLES ########
##################################
root = "/home/linodetest-staging/LinodeTest-Staging/current" # path to application current folder
sock_name = "unicorn_LinodeTest-Staging" # must be unique name with no '.'
